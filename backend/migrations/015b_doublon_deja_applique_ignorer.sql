-- Ce fichier est un DOUBLON de 015_fix_tarifs_unicite_annee.sql (même correctif,
-- trouvé indépendamment par un autre agent). Il a déjà été appliqué en base.
-- Conservé ici seulement pour l'historique, ne pas ré-exécuter séparément.
